...
/datum/job/frontier/doctor
	...
	flag = OUTPOST_DOCTOR
	display_order = JOB_DISPLAY_ORDER_OUTPOSTCMO
...
/// CMO
/datum/job/frontier/outpost_cmo
...
/datum/outfit/job/outpost_cmo/pre_equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	..()
	if(visualsOnly)
		return
	H.mind.teach_crafting_recipe(/datum/crafting_recipe/tribalradio)
...
/datum/job/frontier/roboticist
	title = "Roboticist"
	flag = OUTPOST_ROBOTICIST
	display_order = JOB_DISPLAY_ORDER_OUTPOSTROBOTICIST	
	faction = FACTION_OUTPOST
	total_positions = 1
	spawn_positions = 1
	supervisors = "Generally speaking your only actual supervisor is your own judgement."
...
/datum/job/frontier/researcher
	title = "Researcher"
	flag = OUTPOST_SCIENTIST
	display_order = JOB_DISPLAY_ORDER_OUTPOSTSCIENTIST
	faction = FACTION_OUTPOST
	total_positions = 1
	spawn_positions = 1
	supervisors = "Generally speaking your only actual supervisor is your own judgement."
