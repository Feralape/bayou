...
#define FACTION_DRIFTER "Drifter"
...
#define OUTPOST_GOVERNOR (1<<0)
#define OUTPOST_MARSHALL (1<<1)
#define OUTPOST_CMO		 (1<<2)
#define OUTPOST_CE	 	 (1<<3)
#define OUTPOST_TRADER	 (1<<4)
#define	OUTPOST_ENGINEER (1<<5)
#define DOCK_WORKER		  (1<<6)
#define OUTPOST_RANGER 	  (1<<7)
#define OUTPOST_OFFICER	  (1<<8)
#define OUTPOST_DOCTOR	  (1<<9)
#define OUTPOST_SCIENTIST (1<<10)
#define OUTPOST_ROBOTICIST (1<<11)
#define OUTPOST_PILOT    (1<<12)
#define OUTPOST_BARTENDER (1<<13)
#define OUTPOST_COLONIST (1<<14)
...
#define JOB_DISPLAY_ORDER_GOVERNOR 34
#define JOB_DISPLAY_ORDER_MARSHALL 35
#define JOB_DISPLAY_ORDER_RANGER	36
#define JOB_DISPLAY_ORDER_OFFICER	37
#define JOB_DISPLAY_ORDER_PILOT		38
#define JOB_DISPLAY_ORDER_OUTPOSTCMO 39
#define JOB_DISPLAY_ORDER_DOCTOR 40
#define JOB_DISPLAY_ORDER_TRADER 41
#define JOB_DISPLAY_ORDER_DOCKWORKER 42
#define JOB_DISPLAY_ORDER_OUTPOSTCE 43
#define JOB_DISPLAY_ORDER_OUTPOSTENGINEER 44
#define JOB_DISPLAY_ORDER_OUTPOSTSCIENTIST 45
#define JOB_DISPLAY_ORDER_OUTPOSTROBOTICIST	46 
#define JOB_DISPLAY_ORDER_OUTPOSTBARTENDER 47
#define JOB_DISPLAY_ORDER_COLONIST 48

#define JOB_DISPLAY_ORDER_OUTLANDER 49
#define JOB_DISPLAY_ORDER_RADIOOP 49
