...
/obj/structure/flora/tree/oak/Initialize()
	. = ..()
...
/obj/structure/flora/grass/coyote
	name = "dead grass"
	icon = 'modular_coyote/icons/objects/flora.dmi'
	icon_state = "1"
	anchored = TRUE

/obj/structure/flora/grass/coyote/Initialize()
	. = ..()
...
/obj/structure/flora/burnedtree
	name = "burned tree"
	icon = 'modular_coyote/icons/objects/flora.dmi'
	icon_state = "burnedtree1"
	anchored = TRUE

/obj/structure/flora/burnedtree/Initialize()
	. = ..()
...
/obj/structure/flora/tallgrass/Initialize()
	. = ..()
	icon_state = "tall_grass_[rand(1,9)]"
